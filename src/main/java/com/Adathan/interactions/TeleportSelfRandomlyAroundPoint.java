...
public class TeleportSelfRandomlyAroundPoint extends SimpleInstantInteraction {
    ...
    static {
        CODEC = BuilderCodec.builder(TeleportSelfRandomlyAroundPoint.class, TeleportSelfRandomlyAroundPoint::new, SimpleInstantInteraction.CODEC)
                .documentation("Teleports self entity to random coordinates around a static point given a radius.")
                ...
                .documentation("Static X to teleport around").addValidator(Validators.nonNull()).add()
                ...
                .documentation("Static Y to teleport around").addValidator(Validators.nonNull()).add()
                ...
                .documentation("Static Z to teleport around").addValidator(Validators.nonNull()).add()
                ...
                .documentation("Radius to randomly teleport around").add()
                .build();
    }
}